...
AC_SUBST([swigmspsrc], [${geocal_topdir}/bindings/python/msp_swig])
...
AC_SUBST([geocalpkgpythondatadir],[\${prefix}/\${pythondir}/geocal/data])
AC_SUBST([geocalpkgpythondataisiscameradir],[\${prefix}/\${pythondir}/geocal/data/isis_camera])
