...
$! VPACK Version 1.8, Wednesday, December 21, 1994, 15:03:22
$!
...
C
      ...
      LOGICAL XVPTST
      LOGICAL MSS,DONT,CHECK,PBAND,PR,PB,MN
...
! INTEGER variable initialization
     ...
     &     ITEMP/0/
      ...
      DATA MSS/0/,DONT/0/,CHECK/0/,PBAND/0/,PR/0/,PB/0/,MN/0/
...
C        LOAD BUFFERS
      ...
      DO J = 1, NFILES			! determine SL within image file(s)
         IF (MSS) THEN			! according to format of files
