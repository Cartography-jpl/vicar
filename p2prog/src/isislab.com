...
$! VPACK Version 1.9, Thursday, November 03, 2005, 12:47:47
$!
...

{
  ...
  if (stat) {
    ...
    stat = zvread( iun, buf, "LINE", 1, "NSAMPS", RECL, 0);
    goto listl;
  }
