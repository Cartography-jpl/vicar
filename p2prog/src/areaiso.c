...
void splie2(double x[] , double y[], double **z, int cols, int rows,
	    double **z2x, double **z2y);
void gaussj();
void sor_test();
...
void calc_fvec(int n, double* E, double* F, double* G, double* e, double* f, 
	       double* g, double* fvec)
{
   int i, j, num_steps;
   num_steps = n;
   for(j = 1; j <= num_steps; ++j)
