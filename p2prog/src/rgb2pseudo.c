...
void rgb_to_image_and_luts(red,green,blue,composite,red_lut,green_lut,blue_lut,nl,ns,bits_used)
...
void output_message(msg, p1, p2, p3, p4, p5, p6, p7, p8)
  char *msg;
