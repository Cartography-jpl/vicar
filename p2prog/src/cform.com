...
$! VPACK Version 1.9, Tuesday, October 10, 2000, 14:39:10
$!
...
c                      both orecl and irecl compares are corrected.
     ...
     2             DOUT(1),COUT(1))
      ...
      IF (BINARY) THEN 
	CALL XVOPEN(IUN,STAT,'OPEN_ACT',' ','IO_ACT','SA','COND','BINARY',
	1 ' ')
      ELSE 
...
C
	...
	1 'NSAMPS', NSBI, 'SAMP', 1, 'BAND', IB, ' ')
        CALL XVWRIT( OUN, BUFOUT, STAT, 'LINE', LINE, 'NSAMPS', NSO,
	1 'SAMP', NSBI+1, 'BAND', IB, ' ')
C
      END DO
      END DO
