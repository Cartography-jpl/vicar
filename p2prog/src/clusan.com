...
$! VPACK Version 1.8, Friday, March 23, 2001, 15:23:27
$!
...
C		GET THE INPUT PARAMETERS
        CALL IFMESSAGE('CLUSAN (double precision) vers. 23-MAR-01')
...
C			CALCULATE THE CHANGE IN ENERGY
	    ...
	    WRITE (STRING,119),'   CHANGES:',NCHANGE, '   CLUSTERS:',NCLUS
	    CALL NPRINT (STRING)
...
C	OUTPUT THE STATISTICS DATASET
	...
	DO C = 1,NCLUS			! for each cluster
	    ENCODE(3,111,CLASNAM(6:8)) C	! 8 byte class name
111	    FORMAT (I3)
	    CLASNAM(1:5) = 'CLASS'
