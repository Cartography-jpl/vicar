...
$! VPACK Version 1.9, Thursday, June 19, 2008, 14:06:23
$!
...
void get_keyword_value (char *key, char *location, char *type, char *task, 
   ...
   /* retrive value from property label */
      ...
      count = MAX_TASKS;
      zlhinfo(unit, tasks, instances, &count, "ULEN", KEY_SIZE+1, 0);
