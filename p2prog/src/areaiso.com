...
$! VPACK Version 1.9, Wednesday, January 24, 2007, 11:51:37
$!
...
/* process picture data */
 for(line=1; line <= nl; line++){
  ...
  status=zvwrit(ounit[1],lat_buf,"LINE",line,0);
  zvsignal(ounit[1],status,1);
  status=zvwrit(ounit[2],lon_buf,"LINE",line,0);
  zvsignal(ounit[2],status,1);
  status=zvwrit(ounit[3],area_buf,"LINE",line,0);
  zvsignal(ounit[3],status,1);
  status=zvwrit(ounit[4],angle_buf,"LINE",line,0);
  zvsignal(ounit[4],status,1);
  status=zvwrit(ounit[5],dlat_buf,"LINE",line,0);
  zvsignal(ounit[5],status,1);
  status=zvwrit(ounit[6],dlon_buf,"LINE",line,0);
