...
$! VPACK Version 1.9, Wednesday, September 02, 1998, 16:26:05
$!
...
*/
   ...
   status=zvwrit(ounit1,Ebuf,"LINE",line,0);
   zvsignal(ounit1,status,1);
   status=zvwrit(ounit2,Fbuf,"LINE",line,0);
   zvsignal(ounit2,status,1);
   status=zvwrit(ounit3,Gbuf,"LINE",line,0);
   zvsignal(ounit3,status,1);
   status=zvwrit(ounit4,Rbuf,"LINE",line,0);
   zvsignal(ounit4,status,1);
 }                      /* line loop */
