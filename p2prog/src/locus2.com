...
$! VPACK Version 1.8, Tuesday, October 21, 1997, 09:41:16
$!
...
c
      ...
      CALL QPRINT('0 DEGREES OF FREEDOM ALLOWED              MATRIX FOR 
     1LINEAR                OFFSET PART OF         RESULTING RMS',111)
      CALL QPRINT('   IN MINIMIZING THE RMS                   PART OF TR
     1ANSFORMATION           TRANSFORMATION',90)
      UI=0.D0
      VI=0.D0
      NRET=0
C
...
C--------MAKE SRO OUTPUT FILES 
	 FILE = FILES(1)
	 OPEN(70,NAME=FILE,STATUS='UNKNOWN',
     1           RECL=IREC,IOSTAT=J,ERR=991)
	 FILE = FILES(2)
	 OPEN(71,NAME=FILE,STATUS='UNKNOWN',
     1           RECL=IREC,IOSTAT=J,ERR=991)
	 FILE = FILES(3)
	 OPEN(72,NAME=FILE,STATUS='UNKNOWN',
     1           RECL=IREC,IOSTAT=J,ERR=991)
...
C--------MAKE UNC OUTPUT FILES 
	 ...
	 FILE = FILES(1)
	 OPEN(80,NAME=FILE,STATUS='UNKNOWN',
     1           RECL=IREC,IOSTAT=J,ERR=991)
	 FILE = FILES(2)
	 OPEN(81,NAME=FILE,STATUS='UNKNOWN',
     1           RECL=IREC,IOSTAT=J,ERR=991)
	 FILE = FILES(3)
	 OPEN(82,NAME=FILE,STATUS='UNKNOWN',
     1           RECL=IREC,IOSTAT=J,ERR=991)
...
C-------MAKE TABLE OF RADIAL DISTANCES VS. SRO MAG AND UNC MAG 
	IREC = 61
	OPEN(90,NAME=FILE,STATUS='UNKNOWN',
     1          RECL=IREC,IOSTAT=J,ERR=991)
