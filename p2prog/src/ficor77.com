...
$! VPACK Version 1.9, Monday, May 24, 1999, 17:53:23
$!
...
C
      SUBROUTINE MAIN44
      COMMON/C1/WORK(10000)		!A large work area
      ...
      LOGICAL XVPTST
C
      CALL IFMESSAGE('FICOR77 version 24 May 1999')
C
      IBUG = 0
...
C
     ...
     &     MAXC0,MAXD0,div)
      INTEGER*4 IPIC(8),ICAL(8),IDARK(8)
