...
$! VPACK Version 1.8, Thursday, June 20, 1996, 15:06:33
$!
...
C
     ...
     .PX,PY,OX2,OY2,SQ,XT,YT,PMJ,PMN,CYCLE,XIGNOR,YIGNOR
      ...
      REAL*4 IGNOAR(2)
      LOGICAL XVPTST
      LOGICAL INLINE,CONTIN,OUTSID,LPRNT,G2FLAG,EXCLOS,NFLAG
      ...
      DATA IDN,IBDN/255,0/,DEBUG,CONTIN,OUTSID/3*.FALSE./,CLOSR/-1/
