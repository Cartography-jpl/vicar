...
$! VPACK Version 1.7, Wednesday, July 20, 1994, 13:56:21
$!
...
C     TRANSFORM/COMPLEX PICTURE DISPLAY PROGRAM
      ...
      IMPLICIT REAL (V)
      COMMON /C1/ C(1200),CFACT(1200),VR(1200),VI(601)
...
C  (DEFAULTS ARE TRANSFORM & AMPL)
	...
	LSW = 5
      ...
      CALL XVPARM( 'R_DISP', BUF3, I, DFLAG,32)
	...
	RSW = 5
      ...
      CALL XVPARM( 'ORIGIN', XY, I, J,2)

      CALL XVPARM( 'NMIN', SMIN, I, J,1)
      CALL XVPARM( 'NMAX', SMAX, I, J,1)
...
C  CHECK # OF SCRATCH FILES
      CALL XVPARM( 'OUT', BUF3, NDATS, I,32)
      IF (NDATS.EQ.1) THEN
	CALL XVPARM( 'INP', BUF3, NDATS, I,32)
	IF (NDATS.GT.1) THEN
