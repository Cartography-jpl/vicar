...
$! VPACK Version 1.7, Wednesday, July 13, 1994, 13:34:49
$!
...
$ DECK/DOLLARS="$ VOKAGLEVE"
      ...
      IBLK = 0
      JBLK = 0
      CALL IFMESSAGE('POLARECT version 1-JULY-94')
      CALL STACKA(7,TEST,4,10000,(IBLK+1)/2*2,(JBLK+1)/2*2,1000000,IGOT)
      CALL STACKA(7,PLRECT,4,10000,(IBLK+1)/2*2,(JBLK+1)/2*2,IGOT,*900)
  900 CONTINUE
      RETURN
      END
C*****************************************************************
      ...
      INTEGER BUF1(1),BUF2(1),BUF3(1),BUF4(1)
      IGOT=L-2048
      RETURN
      END
C*****************************************************************
