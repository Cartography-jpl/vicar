...
$! VPACK Version 1.8, Friday, April 19, 1996, 14:02:27
$!
...
C==================================================================
      CALL IFMESSAGE('PICREG version 17-APR-96')
C
C        ***** SETUP *****
C
...
C        INITIALIZE AND SET DEFAULTS
      ...
      MSG11(1:80) = 
     +' TIEPOINT NO.      HAS THE LARGEST DISAGREEMENT OF       PIXELS W
     +ITH FIT SURFACE'
      MSG13(1:59) = 
     +' L1=         S1=         L2=         S2=         PTNUM=    '
...
C       PRINT FIT INFORMATION
     ...
     .               ' ')
      IF(IFIT.EQ.7) CALL XVMESSAGE('OLD=NEW Y=J+IY+HX+GY**2+FX**2+EXY+DY
     &X**2+CXY**2+BY**3+AX**3',' ')
      CALL XVMESSAGE(' ',' ')
...
C
     ...
     &   'OLD=NEW X=J+IY+HX+GY**2+FX**2+EXY',' ')
      IF(IFIT.EQ.7) CALL XVMESSAGE('OLD=NEW X=J+IY+HX+GY**2+FX**2+EXY+DY
     &X**2+CXY**2+BY**3+AX**3',' ')
      CALL XVMESSAGE(' ',' ')
