...
$! VPACK Version 1.9, Monday, September 14, 1998, 17:26:16
$!
...
$ vpack ephemeris.com -
	...
	-i ephemeris.imake -
	-p ephemeris.pdf -
	-t tstephemeris.pdf tstephemeris_sgi.pdf tstephemeris_hp.pdf
$ Exit
$ VOKAGLEVE
$ Return
$!#############################################################################
...
.help
TSTEPHEMERIS is the unit test for EPHEMERIS for the Alpha and Sun-Solaris.
See TSTEPHEMERIS_SGI.PDF and TSTEPHEMERIS_HP.PDF for the corresponting
SGI and HP tests.
.end
$!-----------------------------------------------------------------------------
$ create tstephemeris_sgi.pdf
!SGI test for VICAR program EPHEMERIS
procedure
refgbl $echo
body
let _onfail="continue"
let $echo="yes"
ephemeris viewer=earth object=venus epoch="13 FEB 1990 5:58:16.962" +
  spicefile="/project/spice/ops/sgi/t900129.bsp_1"
end-proc
$!-----------------------------------------------------------------------------
$ create tstephemeris_hp.pdf
!HP test for VICAR program EPHEMERIS
procedure
refgbl $echo
body
let _onfail="continue"
let $echo="yes"
ephemeris viewer=earth object=venus epoch="13 FEB 1990 5:58:16.962" +
  spicefile="/project/spice/ops/hp-700/t900129.bsp_1"
end-proc
$ Return
$!#############################################################################
