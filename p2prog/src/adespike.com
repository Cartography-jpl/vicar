...
$! VPACK Version 1.8, Wednesday, July 24, 1996, 12:12:32
$!
...
9900  FORMAT (
     +'     TOTAL NUMBER OF PIXELS CORRECTED USING ADJACENT SCAN LINE TE
     +ST       ',I6)
      CALL XVMESSAGE(VTOTAL(2:80),' ')
      WRITE (HTOTAL,9910) HTOT
9910  FORMAT (
     +'     TOTAL NUMBER OF PIXELS CORRECTED USING SAME SCAN LINE TEST  
     +         ',I6)
...
Write " At present (June 1994), in order to run the program, the"
...
Write "  MIPL:[MIPL.VGR]E2575251.6 ==> mipl_vgr_e2575251.6 "
Write "  SITOD1:[TEST_DATA.Images] "
Write "              S0061509700.1 ==> test_data_images_s0061509700.1 "
Write " "
...
!
adespike mipl_vgr_e2575251.6 vgrdespike.fil
list mipl_vgr_e2575251.6 (201,21,10,10)
...
!
badlabels  test_data_images_s0061509700.1 redr.1 ENTROPY=NO
