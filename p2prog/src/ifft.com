...
$! VPACK Version 1.9, Wednesday, April 22, 1998, 12:34:59
$!
...
C**********************************************************************
     ...
     &              NCURS, GPLANE, gdn
      ...
      CALL IFMESSAGE('IFFT version 16-JUL-98')
      CALL XVEACTION('SA',' ')
...
C     &                    Used ', ' ')
        CALL XVMESSAGE('Unrecognized Output Size, Display Default       
     .                     Used ', ' ')
       END IF  
      END IF 
c
