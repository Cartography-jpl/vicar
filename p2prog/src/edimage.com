...
$! VPACK Version 1.8, Thursday, December 22, 1994, 10:27:10
$!
...
C                   COMMAND INPUT AND PARSING ROUTINES
	...
	SUBROUTINE GET_COMMAND (CMD_STRING)
	IMPLICIT NONE
...
C                  UTILITY ROUTINES
	...
	REAL	X, Y
	BYTE	RED, GREEN, BLUE, ZERO, TWO55(3)
...
!  PLEASE ALLOCATE A DE ANZA DISPLAY DEVICE BEFORE STARTING THIS TEST.
